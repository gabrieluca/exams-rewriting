...
img = cv2.imread("database_files/exams/NM7510_P3_C_2019_2/NM7510_P3_pacote_C_2_sem_2019-05.png",1) 
...
if pt [0]<1600:
    ...
    RA=img [10:135, 200:920]
    cv2.imshow("RA", RA)
    cv2.waitKey(0)

    Sequencial=img [10:125, 950:1220]
    ...
    Nome=img [123:250, 60:640]
    cv2.imshow("Nome", Nome)
    cv2.waitKey(0)

    Assinatura=img [115:245, 825:1420]
