...
img = cv2.imread("database_files/exams/NM7510_P3_C_2019_2/NM7510_P3_pacote_C_2_sem_2019-38.png",1) 
...
if pt [0]<1600:
    ...
    Assinatura=img [148:205, 851:1385] #Par
    ...
    Assinatura=img [174:239, 870:1410] # Impar 
    cv2.imshow("Assinatura", Assinatura)
    cv2.waitKey(0)
