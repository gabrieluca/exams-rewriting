...
img = cv2.imread("database_files/exams/NM7510_P3_2019_2/NM7510_P3_pacote_A_2_sem_2019-43.png",1) 
...
if pt[0]>1600:
    ...
    img2 = img[int(pt[0]/50)+w+1610:rt[1] + int(f/1.5), pt[0]-1650:rt[0]+w-1650]
