...
def main():
    ...
    img_qdri = img2[1815:2155, 790:1466]
    img_qdrp = img2[1870:2155, 790:1480]
    img_res = img_qdri[:, 345:570]
    ...
    cv2.imshow("Quadro respostas impar:", img_qdri)
    cv2.imshow("Quadro respostas par:", img_qdrp)
    cv2.imshow("respostas:", img_res)

    cv2.imshow("a1)", imgFI[0:110,50:232])
    cv2.waitKey(0)
    cv2.imshow("a2)", imgFI[65:110,232:])
    cv2.waitKey(0)
    cv2.imshow("b)", imgFI[125:155,232:])
    cv2.waitKey(0)
    cv2.imshow("c)", imgFI[180:215,232:])
    cv2.waitKey(0)
    cv2.imshow("d)", imgFI[215:270,232:])
    cv2.waitKey(0)
